...
<h3 align="center">A Software Engineering student passionate about building innovative tech solutions.<br/>Exploring AI, web development, and real-world problem solving.</h3>
  ...
  <table>
    <tr>
      <td width="50%" valign="top">
        ...
        <p>A full-stack real-time chat application with instant messaging, user authentication, and live online status.</p>
        <p>
